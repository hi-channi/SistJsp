	...
	<table class="table table-bordered" style="width: 800px;margin-left: 100px;">
		...
		<tr>
			<td colspan="2" align="center">
				<button type="submit" class="btn btn-warning" style="width: 120px;" onclick="submitContents(this)">등록</button>
				<button type="button" class="btn btn-warning" style="width: 120px;" onclick="location.href='index.jsp?main=board/smartlist.jsp'">목록</button>
			</td>
		</tr>
